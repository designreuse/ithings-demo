...
import ch.ithings.demo.web.filter.CachingHttpHeadersFilter;
import ch.ithings.demo.web.filter.StaticResourcesProductionFilter;
import ch.ithings.demo.web.filter.gzip.GZipServletFilter;
