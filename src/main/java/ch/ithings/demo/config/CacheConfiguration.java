...
@Configuration
@EnableCaching
@AutoConfigureAfter(value = {MetricsConfiguration.class, JpaConfiguration.class})
public class CacheConfiguration {
    ...
    private HazelcastInstance hazelcastInstance() {
        ...
        config.setInstanceName("iThingsDemo");
        ...
        config.getMapConfigs().put("ch.ithings.demo.domain.*", initializeDomainMapConfig());
