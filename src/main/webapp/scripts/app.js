...
var ithingsDemoApp = angular.module('ithingsDemoApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'ithingsDemoAppUtils', 'pascalprecht.translate', 'truncate']);
